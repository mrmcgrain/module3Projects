...
export default function CalcDashBoard() {
    ...
    return (
        ...
        <div id="MainContainer"
            ...
            <div id="container"
                className={`${style.container} ${style.grid} ${style.border}`}>


                <div
                    className={`${style.display}`} id="display">
                    <p
                        className={`${style.output}`}
                        id="output">? {data.output} </p>
                    <p
                        className={`${style.result}`}
                        id="result"> {data.result}</p>
                </div>

                <div
                    className={`${style.border} ${style.clear}  ${style.card} ${style.ac}`}
                    id="clear"
                    name="clear">
                    <button
                ...
                <div
                    className={`${style.border} ${style.card} ${style.one}`}
                    id="one"
                    name="1">
                    <button
                ...
                <div
                    className={`${style.border} ${style.card}`}
                    id="two"
                    name="2">
                    <button
                ...
                <div
                    ...
                    <button value="3"
                        ...
                        name="three"
                        id="three"
                        className={`${style.btn} ${style.three}`}
                    >3</button>
                ...
                <div
                    ...
                    <button
                        ...
                        id="subtract"
                        value="-"
                        className={`${style.btn} ${style.subtract}`}
                    >-</button>
                ...
                <div
                    ...
                    <button onClick={(e) => handleNumberClick(e)}
                        ...
                        id="four"
                        value="4"
                        className={`${style.btn} ${style.four}`}
                    >4</button>
                </div>
                ...
                <div
                    ...
                    <button onClick={(e) => handleNumberClick(e)}
                        ...
                        id="five"
                        value="5"
                        className={`${style.btn} ${style.five}`}
                    >5</button>
                </div>
                ...
                <div
                    ...
                    <button onClick={(e) => handleOperatorClick(e)}
                        ...
                        id="multiply"
                        value="*"
                        className={`${style.btn} ${style.multiply}`}
                    >*</button>
                </div>
                ...
                <div
                    ...
                    <button onClick={(e) => handleNumberClick(e)}
                        ...
                        id="seven"
                        value="7"
                        className={`${style.btn} ${style.seven}`}
                    >7</button>
                </div>
                ...
                <div
                    ...
                    <button onClick={(e) => handleNumberClick(e)}
                        ...
                        id="eight"
                        value="8"
                        className={`${style.btn} ${style.eight}`}
                    >8</button>
                </div>
                ...
                <div
                    ...
                    <button onClick={(e) => handleNumberClick(e)}
                        ...
                        id="nine"
                        value="9"
                        className={`${style.btn} ${style.nine}`}
                    >9</button>
                </div>
                ...
                <div
                    ...
                    <button onClick={(e) => handleOperatorClick(e)}
                        ...
                        id="divide"
                        value="/"
                        className={`${style.btn} ${style.divide}`}
                    >/</button>
                </div>
                ...
                <div
                    ...
                    <button onClick={(e) => handleZeroClick(e)}
                        ...
                        id="zero"
                        value="0"
                        className={`${style.btn} ${style.zero}`}
                    >0</button>
                </div>
                ...
                <div
                    ...
                    <button onClick={(e) => handleDecimal(e)}
                        ...
                        value="."
                        id="decimal"
                        className={`${style.btn} ${style.decimal}`}
                    >.</button>
                </div>
                ...
                >
                    <button
                        ...
                        value="="
                        className={`${style.btn} ${style.equals}`}
                    >=</button>
